   ...
   if (stopPressed) {
      do {
         ...
         await delay(500);
                 ...
                 ((hasAce && dealerAce) && (((sumVal < 22 && dealerSum < 22) && sumVal > dealerSum)
                  || ((sumVal<22 && dealerSum>21) && sumVal>dealerSumWithAce) || 
                 (((sumVal>21 && dealerSum<22) && sumValWithAce < 22) && sumValWithAce > dealerSum)
                  || (((sumVal>21 && dealerSum>21) && sumValWithAce < 22) && sumValWithAce > dealerSumWithAce)))    
      );
      ...
      if (
         ...
         dealerSum > sumVal ||
         (hasAce && dealerSum > sumValWithAce) ||
         (dealerAce && (dealerSumWithAce > sumVal || dealerSum > sumVal))
      ) {
         messageDP.textContent = message[6];
         playerwon = false;
      } else if (
         sumVal > dealerSum ||
         (hasAce && sumValWithAce > dealerSum) ||
         (dealerAce && (sumVal > dealerSumWithAce || sumVal > dealerSum))
      ) {
